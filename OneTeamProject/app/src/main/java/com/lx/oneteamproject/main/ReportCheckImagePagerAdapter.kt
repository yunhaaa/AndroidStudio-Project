...
class ReportCheckImagePagerAdapter(fragmentManager: FragmentManager, lifecycle: Lifecycle) : FragmentStateAdapter(fragmentManager, lifecycle) {
    ...
    override fun createFragment(position: Int): Fragment {
        var fragment = ReportCheckImagePagerItemFragment()
