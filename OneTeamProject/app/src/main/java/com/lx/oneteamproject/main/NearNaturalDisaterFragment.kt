...
import com.lx.oneteamproject.databinding.NearNaturalDisaterFragmentBinding
import com.lx.oneteamproject.databinding.NearRiskInformationFragmentBinding

class NearNaturalDisaterFragment : Fragment() {

    private var _binding: NearNaturalDisaterFragmentBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = NearNaturalDisaterFragmentBinding.inflate(inflater, container, false)
    ...
    private fun initMap() {
        val mapFragment =
            childFragmentManager.findFragmentById(R.id.naturalDisaterFragment) as SupportMapFragment
